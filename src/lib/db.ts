...
export interface OutboxItem {
  id?: number;
  type: 'MESSAGE' | 'EXPENSE' | 'DAY_START' | 'DAY_END' | 'PHASE_COMPLETE' | 'TEAM_UPDATE' | 'MEDIA_UPLOAD' | 'GALLERY_UPLOAD' | 'GALLERY_DELETE' | 'QUOTE' | 'MATERIAL' | 'PROJECT' | 'TASK' | 'TASK_STATUS_TOGGLE';
  projectId: number;
  payload: any;
  timestamp: number;
  lat?: number;
